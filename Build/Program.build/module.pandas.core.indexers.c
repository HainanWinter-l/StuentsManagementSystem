...
static PyCodeObject *codeobj_ca99dc9f8e44e7a0e8616387bc2dd3fb;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[36]); CHECK_OBJECT(module_filename_obj);
    codeobj_ca99dc9f8e44e7a0e8616387bc2dd3fb = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[37], mod_consts[37], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_ca99dc9f8e44e7a0e8616387bc2dd3fb;
    ...
    frame_ca99dc9f8e44e7a0e8616387bc2dd3fb = MAKE_MODULE_FRAME(codeobj_ca99dc9f8e44e7a0e8616387bc2dd3fb, module_pandas$core$indexers);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_ca99dc9f8e44e7a0e8616387bc2dd3fb);
    assert(Py_REFCNT(frame_ca99dc9f8e44e7a0e8616387bc2dd3fb) == 2);
    ...
    // Framed code:
    {
        ...
        frame_ca99dc9f8e44e7a0e8616387bc2dd3fb->m_frame.f_lineno = 1;
        {
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_ca99dc9f8e44e7a0e8616387bc2dd3fb, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_ca99dc9f8e44e7a0e8616387bc2dd3fb->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_ca99dc9f8e44e7a0e8616387bc2dd3fb, exception_lineno);
    }



    assertFrameObject(frame_ca99dc9f8e44e7a0e8616387bc2dd3fb);
