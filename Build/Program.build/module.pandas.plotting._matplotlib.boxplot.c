...
static PyObject *impl_pandas$plotting$_matplotlib$boxplot$$$function__17_boxplot_frame_groupby(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...

    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1, tmp_dircall_arg3_1};
            tmp_assign_source_20 = impl___main__$$$function__5_complex_call_helper_keywords_star_dict(tstate, dir_call_args);
        }
        if (tmp_assign_source_20 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
    ...
    branch_no_4:;
    {
...

        {
            ...
            tmp_assign_source_32 = impl___main__$$$function__5_complex_call_helper_keywords_star_dict(tstate, dir_call_args);
        }
        if (tmp_assign_source_32 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
