...
static PyCodeObject *codeobj_2c2dedc8a0c86810e2dd572e120481fe;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[54]); CHECK_OBJECT(module_filename_obj);
    codeobj_2c2dedc8a0c86810e2dd572e120481fe = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_FUTURE_ANNOTATIONS, mod_consts[55], mod_consts[55], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_2c2dedc8a0c86810e2dd572e120481fe;
    ...
    frame_2c2dedc8a0c86810e2dd572e120481fe = MAKE_MODULE_FRAME(codeobj_2c2dedc8a0c86810e2dd572e120481fe, module_pandas$tseries$offsets);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_2c2dedc8a0c86810e2dd572e120481fe);
    assert(Py_REFCNT(frame_2c2dedc8a0c86810e2dd572e120481fe) == 2);
    ...
    }
    {
        ...
        frame_2c2dedc8a0c86810e2dd572e120481fe->m_frame.f_lineno = 3;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_2c2dedc8a0c86810e2dd572e120481fe, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_2c2dedc8a0c86810e2dd572e120481fe->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_2c2dedc8a0c86810e2dd572e120481fe, exception_lineno);
    }



    assertFrameObject(frame_2c2dedc8a0c86810e2dd572e120481fe);
