...
static void createModuleCodeObjects(void) {
    ...
    codeobj_6f0bcbdd90daaa3f1114882152f2361f = MAKE_CODE_OBJECT(module_filename_obj, 57, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[38], mod_consts[38], mod_consts[44], NULL, 1, 0, 0);
}
...
static PyObject *impl_PIL$GimpPaletteFile$$$function__1___init__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Framed code:
    {
        ...
        }
        {
            ...
            frame_d8377779d3f576fd51314af6bffd3321->m_frame.f_lineno = 29;
...
static PyObject *impl_PIL$GimpPaletteFile$$$function__2_getpalette(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_6f0bcbdd90daaa3f1114882152f2361f)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_6f0bcbdd90daaa3f1114882152f2361f = MAKE_FUNCTION_FRAME(tstate, codeobj_6f0bcbdd90daaa3f1114882152f2361f, module_PIL$GimpPaletteFile, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_6f0bcbdd90daaa3f1114882152f2361f);
