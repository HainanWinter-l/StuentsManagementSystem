...
function_impl_code functable_matplotlib$tri$_tripcolor[] = {
    impl_matplotlib$tri$_tripcolor$$$function__1_tripcolor,
    NULL
};
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_matplotlib$tri$_tripcolor;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_matplotlib$tri$_tripcolor) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_matplotlib$tri$_tripcolor[offset],
        code_object->co_name,
#if PYTHON_VERSION >= 0x300
